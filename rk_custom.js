...
function movs_page_imgdown(){
  document.addEventListener('click', function (e) {
    ...
    if ( e.target.classList.contains( 'toggleimg' ) ) {
      ...
      var images = document.querySelectorAll('.slick-slide img,.player-video .video-js,article .card-thumb__img img,.picture-list a img,.mov_collection img.mov_col_img,.model-picture__thumb img,.gallery-thumbs .gallery-thumb__img').forEach(function (image) {
        if (using_nsfw){
