...
('<div class="item-list">' +
'<i class="'+ pubg.icon +'"></i>' +
'<p class="name" datai18n="'+ pubg.item +'">'+ pubg.name +' '+ pubg.number +'</p>' +
'<div class="list-info">'+
...
'<i class="'+ pubg['icon'] +'"></i>' +
'<p class="name" datai18n="'+ pubg['i18n'] +'">'+ pubg['name'] +'</p>' +
'<div class="list-info">'+
'<p class="info" datai18n="'+pubg.i18type+'">'+pubg.unique+'</p>'+
'</div>'+
'</a>')
...
'<div class="l-details">'+
'<p>'+
'<span class="type" datai18n="'+pubg.unique+'">'+pubg.unique+'</span>'+
'</p>'+
'</div>'+
'<div class="r-details">'+
'<p>'+
'<span class="bonus" datai18n="'+pubg.bonustype1i18+'">'+pubg.bonustype1+'</span>'+
'<span class="lvalue">'+pubg.bonus1+'</span>'+
'</p>'+
'<p>'+
'<span class="bonus" datai18n="'+pubg.bonustype2i18+'">'+pubg.bonustype2+'</span>'+
'<span class="lvalue">'+pubg.bonus2+'</span>'+
'</p>'+
'<p>'+
'<span class="bonus" datai18n="'+pubg.bonustype3i18+'">'+pubg.bonustype3+'</span>'+
'<span class="lvalue">'+pubg.bonus3+'</span>'+
'</p>'+
'</div>'+
'</div>'+
'<div class="item-image">'+
...
'<span class="description" datai18n="'+pubg.i18desc+'">'+pubg.desc+'</span>'+
'</div>'+
'<div class="attachableto" datai18n="AttachableTo">Attachable to:</div>'+
...
'<div class="l-details">'+
'<p>'+
'<span class="cap" datai18n="Damage">Damage:</span>'+
